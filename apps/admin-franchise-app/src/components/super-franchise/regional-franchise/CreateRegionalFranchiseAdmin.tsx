...
export default function CreateRegionalFranchiseAdmin() {
	...
	useEffect(() => {
		const fetchFranchises = async () => {
			const res = await fetch(
				"/api/super-franchise/regional-franchise/available-regional-franchise"
			);
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			const res = await fetch(
				"/api/super-franchise/regional-franchise/regional-franchise-admin",
				{
					method: "POST",
			...
			toast.success("regional Franchise admin created successfully!");
		} catch (err) {
			console.error(err);
	...
	return (
		<form
			...
			<h2 className="text-3xl font-semibold text-center text-gray-800">
				Create Regional Franchise Admin
			</h2>
