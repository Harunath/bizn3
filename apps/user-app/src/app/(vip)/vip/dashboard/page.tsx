...
const page = () => {
	return (
		<div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-4">
			<h1 className="text-3xl font-bold text-gray-800 mb-4">VIP Dashboard</h1>
			...
			<div className="mt-4">
				...
				<div className="flex gap-4 items-center">
					<Link href="/vip/referral">Referral</Link>
					<Link href="/vip/referral/create">Create Referral</Link>
				</div>
			</div>
		</div>
	);
