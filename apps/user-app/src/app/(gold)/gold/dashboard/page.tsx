...
const page = () => {
	return (
		<div className="min-h-screen bg-gray-50 py-12 px-4 flex flex-col items-center justify-center">
			...
			{/* Profile Link */}
			<div className="text-red-600 flex items-center space-x-2 hover:text-red-700 transition-colors mb-10">
			...
			<div className="mt-4 w-full max-w-2xl">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
					...
					<Link
						href="/gold/referral"
						className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg border border-transparent hover:border-red-600 transition">
